...
Action.setDispatcher(defaults.dispatcher);
Store.setDispatcher(defaults.dispatcher);
...
module.exports = {
  ...
  getDispatcher: function() {
    return _opts.dispatcher || defaults.dispatcher;
  },
  enums: require('./enums'),
  mixins: {
    ListenerMixin: require('./mixins/listener')
  }
};
